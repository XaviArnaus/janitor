...
CONFIG = {
    ...
    "app.credentials.user_file": "user.secret",
    "app.credentials.client_file": "client.secret",
    "app.api_base_url": "https://mastodont.cat",
    "app.credentials.user.email": "bot+syscheck@my-fancy.site",
